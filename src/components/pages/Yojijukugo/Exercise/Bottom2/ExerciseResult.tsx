...
import { YojijukugoBottom2Answer, YojijukugoBottom2Question } from ".";

export type ExerciseResultProps = {
  results: Result<YojijukugoBottom2Question, YojijukugoBottom2Answer>[];
};
            ...
            {results.map((result) => {
              return (
                <Table.Row key={result.question_no}>
                  ...
                  <Table.Cell>{result.question.question}</Table.Cell>
                  <Table.Cell>
                    <Link
                      target="_blank"
